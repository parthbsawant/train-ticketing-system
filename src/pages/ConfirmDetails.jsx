...
const ConfirmDetails = () => {
  ...
  const handlePayment = async () => {
    ...
    // 👉 redirect to new payment page instead of processing here
    navigate('/payment', {
      state: bookingData
    });
  };
        ...
        >
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                ...
                <span className="font-semibold">
                  ₹{bookingData.train.classes[bookingData.selectedClass].price}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Number of Passengers:</span>
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 mb-6">
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-4">
              ...
              <p className="text-gray-500 text-xs mt-1">
                You will choose payment method on next screen.
              </p>
            </div>
            <button
              onClick={handlePayment}
